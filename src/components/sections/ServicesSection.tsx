...
export default function ServicesSection() {
  return (
    <div className="flex overflow-hidden w-full flex-col py-16 px-[108px] bg-white antialiased text-xs max-w-8xl mx-auto">
      {/* Email Bar */}
      ...
      <div className="flex justify-between items-start w-full pb-20">
        ...
        <div className="max-w-[400px] pt-6 m-0">
      ...
      <div className="flex w-full gap-12">
        ...
        <div className="flex grow gap-6 flex-wrap md:flex-nowrap">
          ...
          <div className="flex flex-col justify-between p-10 shrink-0 bg-[#111111] w-[320px] h-[320px] hover:scale-[1.02] transition-all duration-300 rounded-xl group">
          ...
          <div className="flex flex-col justify-between p-10 shrink-0 bg-white border border-[#EBEBEB] shadow-sm hover:border-[#111111] w-[320px] h-[320px] hover:scale-[1.02] transition-all duration-300 rounded-xl group">
